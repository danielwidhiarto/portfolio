...
A minimal, editorial portfolio for teaching, research, and software engineering work. The home page features an auto-rotating 3D project map: hover to reveal a project, click to open its details, or hold either mouse button and drag to rotate the map. Numbered project buttons provide an accessible alternative to the canvas.
